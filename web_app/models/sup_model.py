...
from models.temporal_modeling import temporal_modeling_module
...
class ResNet(nn.Module):
    ...
    def __init__(self, depth, num_frames, num_classes=2, dropout=0.5, zero_init_residual=False,
                 without_t_stride=True, temporal_module=None, pooling_method='max'):
